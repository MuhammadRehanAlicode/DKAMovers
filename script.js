...
const translations = {
  en: {
    ...
    s3_title:"Parcel Delivery", s3_text:"Door-to-door parcel and item transport around Dubai with secure handling.",
  ...
  ar: {
    ...
    s3_title:"توصيل الطرود", s3_text:"نقل الطرود والأغراض من الباب إلى الباب داخل دبي مع التعامل الآمن.",
